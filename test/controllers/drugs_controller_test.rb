...
class DrugsControllerTest < ActionController::TestCase
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post :create, drug: { interactions: @drug.interactions, name: @drug.name, overdose: @drug.overdose, precautions: @drug.precautions, sideeffects: @drug.sideeffects, uses: @drug.uses }
    end
  ...
  test "should update drug" do
    patch :update, id: @drug, drug: { interactions: @drug.interactions, name: @drug.name, overdose: @drug.overdose, precautions: @drug.precautions, sideeffects: @drug.sideeffects, uses: @drug.uses }
    assert_redirected_to drug_path(assigns(:drug))
  end
