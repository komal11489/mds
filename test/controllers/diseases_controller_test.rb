...
class DiseasesControllerTest < ActionController::TestCase
  ...
  test "should create disease" do
    assert_difference('Disease.count') do
      post :create, disease: { cause: @disease.cause, name: @disease.name, symptom: @disease.symptom, treatment: @disease.treatment }
    end
  ...
  test "should update disease" do
    patch :update, id: @disease, disease: { cause: @disease.cause, name: @disease.name, symptom: @disease.symptom, treatment: @disease.treatment }
    assert_redirected_to disease_path(assigns(:disease))
  end
